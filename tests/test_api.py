"""Tests for GreenEye Monitor (GEM) api."""
import asyncio

import aiohttp
from custom_components.greeneye_monitor.api import (
    GreeneyeMonitorApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = GreeneyeMonitorApiClient("test", "test", async_get_clientsession(hass))
